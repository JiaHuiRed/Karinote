...
> **个人状态记录本 + 数字人桌宠 — 只存本地，命令行交互，追踪睡眠、心情与身体数据，桌上有雨琦陪你。**
> 作者：Red · Karina (敏敏)

[![版本](https://img.shields.io/badge/版本-0.0.5-orange)](CHANGELOG.md)
...
同时内置 **RedPar 电子管家桌宠** — 桌面上的 Live2D 看板娘雨琦，能读取你的 Karinote 数据，主动关心你的睡眠、心情和身体状态，陪你聊天解闷。
